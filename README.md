...
* [Jun 2025] We update the codebase with a faster pose graph optimization and faster front-end implementation. 
...
2. Run with the following command
    ...
    ```bash
    $ cd workspace
    $ python3 MACVO.py --odom Config/Experiment/MACVO/MACVO_performance.yaml --data Config/Sequence/TartanAir_example.yaml
    ```
